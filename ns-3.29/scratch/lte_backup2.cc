...
{
  //Também funciona//Config::SetDefault("ns3::LteEnbNetDevice::UlBandwidth", UintegerValue(25));
  ...
  tag     << "_radius"  << std::setw (3) << std::setfill ('0') << std::fixed << std::setprecision (0) << radius
  ...
  lteHelper->SetEnbDeviceAttribute("DlBandwidth", UintegerValue(25)); //Número de RBs
  // Create Nodes: eNodeB and UE
  NodeContainer enbNodes;
  NodeContainer ueNodes1, ueNodes2;
  enbNodes.Create (1);
  ueNodes1.Create (numUes);
  ueNodes2.Create (numUes2);
  ...
  lteHelper->ActivateDataRadioBearer (ueDevs2, bearer2);
  //
