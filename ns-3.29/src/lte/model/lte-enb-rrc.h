...
public:
  ...
  void SetSliceOptimizer(SlicesOptimizer* sliceOptimizer); //Adicionei
  void SetUplinkSliceOptimizer(SlicesOptimizer* uplinkSliceOptimizer);
  /** 
...
private:
  ...
  SlicesOptimizer* m_sliceOptimizer; //Adicionei
  SlicesOptimizer* m_uplinkSliceOptimizer; //Adicionei
