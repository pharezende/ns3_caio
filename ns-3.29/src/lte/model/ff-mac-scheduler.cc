...
void
FfMacScheduler::SetSlicesOptimizer(SlicesOptimizer* so){
	m_slicesOptimizer = so;
}

void
FfMacScheduler::SetUplinkSlicesOptimizer(SlicesOptimizer* so){
	m_uplinkSlicesOptimizer = so;
}
