...
public:
	...
	SlicesOptimizer* GetSlicesOptimizer();
	SlicesOptimizer* GetUplinkSlicesOptimizer();
	virtual void DoDispose(void);

	void ActivateSliceOptimizer(); //Serve apenas para chamar o DoConfigureSliceOptimizer
	/**
	 ...
	 * \param [in] tbs1Size
	 */
	typedef void (*DlSchedulingTracedCallback)(uint32_t frame,
			uint32_t subframe, uint16_t rnti, uint8_t mcs0, uint16_t tbs0Size,
	 ...
	 * \param [in] tbsSize
	 */
	typedef void (*UlSchedulingTracedCallback)(uint32_t frame,
			uint32_t subframe, uint16_t rnti, uint8_t mcs, uint16_t tbsSize);
...
private:
	...
	void DoCschedUeConfigCnf(
			FfMacCschedSapUser::CschedUeConfigCnfParameters params);
	void DoCschedLcConfigCnf(
			FfMacCschedSapUser::CschedLcConfigCnfParameters params);
	void DoCschedLcReleaseCnf(
			FfMacCschedSapUser::CschedLcReleaseCnfParameters params);
	void DoCschedUeReleaseCnf(
			FfMacCschedSapUser::CschedUeReleaseCnfParameters params);
	...
	void DoSchedUlConfigInd(
			FfMacSchedSapUser::SchedUlConfigIndParameters params);
...
private:
	SlicesOptimizer* m_slicesOptimizer;
	SlicesOptimizer* m_uplinkSlicesOptimizer;
